...
class Frame:
    ...
    def define(self, symbol, value):
        ...
        # BEGIN PROBLEM 1 (done by benedict)
    ...
    def lookup(self, symbol):
      ...
      if symbol in self.bindings:
          ...
          # If the symbol is not found in the current frame, look up in the parent frame.
    ...
    def make_child_frame(self, formals, vals):
      ...
      # BEGIN PROBLEM 8 (done by michael)
      # Create a new Frame instance with SELF as the parent
